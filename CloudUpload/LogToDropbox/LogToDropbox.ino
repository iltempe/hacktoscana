...
void loop () {
  ...
  File dataFile = FileSystem.open("/mnt/sda1/LogToDropbox/datalog_2.csv", FILE_APPEND);
  ...
  // if the file isn't open, pop up an error:
    ...
    Serial.println("error opening datalog_2.csv");
  } 
  Process upload;
  upload.runShellCommand("python /mnt/sda1/LogToDropbox/log.py /mnt/sda1/LogToDropbox/datalog_2.csv");  // upload the file we just wrote to to Dropbox
 ...
 while(upload.available()) {
  ...
  //una misura (ed un upload ogni 30 secondi)
  delay(30000);
